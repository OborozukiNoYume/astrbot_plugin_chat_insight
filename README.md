...
| `/词云` | `wordcloud` | `[时间]`（默认自己） | 个人词云；查他人三种写法均可：`/词云 @某人 [时间]`、`@某人 /词云 [时间]`、`@某人 词云`；`/词云 全群 [时间]` 查整群，`群 <群号>` 指定群（兼容 `user me` / `group` 英文写法） |
